...
{
    public static var _customTitle               : UIColor
    {
    ...
    public static var _customLabel               : UIColor
    {
    ...
    public static var _customSecondaryLabel      : UIColor
    {
    ...
    public static var _customPrimaryBackground   : UIColor
    {
    ...
    public static var _customSecondaryBackground : UIColor
    {
    ...
    public static var _customViewSelected        : UIColor
    {
    ...
    public static var _customTabBarItemSelected  : UIColor
    {
    ...
    public static var _customSegmentedOneSelectedText: UIColor
    {
        if #available(iOS 13.0, *)
        {
    ...
    public static var _customSegmentedOneNormalText  : UIColor
    {
