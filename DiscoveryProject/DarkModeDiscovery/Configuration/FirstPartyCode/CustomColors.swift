...
extension UIColor: UICustomColorsProtocol {
    public static var customTitle: UIColor {
        return AppearanceService.shared.style == .light ? #colorLiteral(red: 0.1294117719, green: 0.2156862766, blue: 0.06666667014, alpha: 1) : #colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1)
    }

    public static var customLabel: UIColor {
        return AppearanceService.shared.style == .light ? #colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1) : #colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1)
    }

    public static var customSecondaryLabel: UIColor {
        return AppearanceService.shared.style == .light ? #colorLiteral(red: 0.5058823824, green: 0.3372549117, blue: 0.06666667014, alpha: 1) : #colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1)
    }

    public static var customPrimaryBackground: UIColor {
        return AppearanceService.shared.style == .light ? #colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1) : #colorLiteral(red: 0.2373828888, green: 0.2660574913, blue: 0.4256682396, alpha: 1)
    }

    public static var customSecondaryBackground: UIColor {
        return AppearanceService.shared.style == .light ? #colorLiteral(red: 0.7254902124, green: 0.4784313738, blue: 0.09803921729, alpha: 1) : #colorLiteral(red: 0.1411764771, green: 0.3960784376, blue: 0.5647059083, alpha: 1)
    }

    public static var customViewSelected: UIColor {
        return AppearanceService.shared.style == .light ? #colorLiteral(red: 0.9607843161, green: 0.7058823705, blue: 0.200000003, alpha: 1) : #colorLiteral(red: 0.3201489481, green: 0.3111480434, blue: 0.438789345, alpha: 1)
    }
